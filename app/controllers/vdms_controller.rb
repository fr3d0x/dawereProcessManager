class VdmsController < ApplicationController
  ...
  def resumable_upload
    ...
    FileUtils::mkdir_p params[:upload].original_filename
    dir = "/tmp/#{params[:upload].original_filename}"
    #chunk path based on the parameters
    chunk = "#{dir}/#{params[:upload].original_filename}.part#{params[:chunkNumber]}"
